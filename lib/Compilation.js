...
class Compilation extends Tapable {
	...
	buildModule(module, optional, origin, dependencies, thisCallback) {
		...
		module.build(
			this.options, // 配置信息
			this, // compilation实例
			this.resolverFactory.get("normal", module.resolveOptions), // normalResolver
			this.inputFileSystem, // 读取文件的文件系统
			error => {
	...
	_addModuleChain(context, dependency, onModule, callback) {
		...
		// 不同的 dependency 其 constructor 不同
